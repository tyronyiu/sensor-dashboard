  ...
  _createClass(Radar, [{
    ...
    value: function renderPolygonStatically(points) {
      var _this$props3 = this.props,
          ...
          baseLinePoints = _this$props3.baseLinePoints,
...
Radar.getComposedData = function (_ref2) {
  ...
  displayedData.forEach(function (entry, i) {
    ...
    points.push(_objectSpread({}, (0, _PolarUtils.polarToCartesian)(cx, cy, radius, angle), {
      name: name,
      value: value,
      cx: cx,
      cy: cy,
  ...
  if (isRange) {
    points.forEach(function (point) {
      if ((0, _isArray2["default"])(point.value)) {
        ...
        baseLinePoints.push(_objectSpread({}, point, {
          radius: radius
